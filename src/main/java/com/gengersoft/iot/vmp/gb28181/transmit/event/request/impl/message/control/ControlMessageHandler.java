package com.gengersoft.iot.vmp.gb28181.transmit.event.request.impl.message.control;
...
@Component
@Slf4j
public class ControlMessageHandler extends AbstractMessageHandler implements InitializingBean, IMessageHandler {

    @Autowired
    private MessageRequestProcessor messageRequestProcessor;

    private static final String rootElement = "Control";
