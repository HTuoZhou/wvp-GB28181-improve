package com.gengersoft.iot.vmp.gb28181.transmit.event.request.impl.message.notify.cmdType;
...
import com.gengersoft.iot.vmp.gb28181.transmit.event.request.impl.message.notify.NotifyMessageHandler;
...
public class KeepAliveNotifyMessageHandler extends AbstractSIPRequestProcessor implements InitializingBean, IMessageHandler {
    ...
    public void process(RequestEvent requestEvent, DeviceBO deviceBO, Element rootElement) {
        ...
        log.info("[Message] [Message {} Keepalive Address:{}]",rootElement.getName(),requestAddress);
        log.debug("[Message] [Message {} Keepalive Content:\n{}]",rootElement.getName(),request);

        Response response = getMessageFactory().createResponse(Response.OK, request);
        sipSender.transmitRequest(request.getLocalAddress().getHostAddress(), response);
        log.info("[Message] [Message {} Keepalive Response Address:{}]",rootElement.getName(),requestAddress);
